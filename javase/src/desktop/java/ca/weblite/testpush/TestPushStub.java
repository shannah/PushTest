 ...
 * @author Shai Almog
 */
public class TestPushStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "TestPush";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new TestPushStub());
    }
